...
const team = [
  ...
  },
  {
    ...
    about: ["Computer Science student and Open Source enthusiast. ",
            "Software Developer & DevOps at Getulio Vargas Foundation, responsible for the development, deployment and maintenance of Mosqlimate's API along with the WP2 group."],
    image: "/img_team/lua.png",
...
export default function AboutPage() {
    return(
    <div> 
      <section className="py-4 px-6 bg-bg mb-20">
