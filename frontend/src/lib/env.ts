export const NEXT_PUBLIC_FRONTEND_URL = process.env.NEXT_PUBLIC_FRONTEND_URL || process.env.FRONTEND_URL || "https://mosqlimate.org";
export const NEXT_PUBLIC_BACKEND_URL = process.env.NEXT_PUBLIC_BACKEND_URL || "https://api.mosqlimate.org";
export const NEXT_PUBLIC_DOCS_URL = process.env.NEXT_PUBLIC_DOCS_URL || "https://api.mosqlimate.org/docs";
