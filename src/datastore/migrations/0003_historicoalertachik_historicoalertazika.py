# Generated by Django 4.2.3 on 2023-09-25 16:54
...
class Migration(migrations.Migration):
    dependencies = [
        ("datastore", "0002_copernicusbrasil"),
    ]
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "tempmin",
                    models.DecimalField(
                        db_column="tempmin", decimal_places=2, max_digits=10
                    ),
                ),
                (
                    "umidmax",
                    models.DecimalField(
                        db_column="umidmax", decimal_places=2, max_digits=10
                    ),
                ),
                ...
                (
                    "umidmed",
                    models.DecimalField(
                        db_column="umidmed", decimal_places=2, max_digits=10
                    ),
                ),
                (
                    "umidmin",
                    models.DecimalField(
                        db_column="umidmin", decimal_places=2, max_digits=10
                    ),
                ),
                (
                    "tempmed",
                    models.DecimalField(
                        db_column="tempmed", decimal_places=2, max_digits=10
                    ),
                ),
                (
                    "tempmax",
                    models.DecimalField(
                        db_column="tempmax", decimal_places=2, max_digits=10
                    ),
                ),
